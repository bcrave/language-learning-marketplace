...
export const interfaceMessages = {
  en: {
    ...
    "roleAssignments.help": "Grant or remove one marketplace Role Assignment, or suspend and reactivate a User across every role. The User and history remain; Project Owner authority is never available here.",
  ...
  es: {
    ...
    "roleAssignments.help": "Otorgue o elimine una asignación de rol del mercado, o suspenda y reactive un usuario en todos sus roles. Se conservan el usuario y el historial; la autoridad de Propietario del proyecto nunca está disponible aquí.",
