...
export const interfaceMessages = {
  en: {
    ...
    "roleAssignments.help": "Grant or remove one marketplace Role Assignment at a time. The User, other roles, and history remain; Project Owner authority is never available here.",
  ...
  es: {
    ...
    "roleAssignments.help": "Otorgue o elimine una asignación de rol del mercado a la vez. Se conservan el usuario, los demás roles y el historial; la autoridad de Propietario del proyecto nunca está disponible aquí.",
