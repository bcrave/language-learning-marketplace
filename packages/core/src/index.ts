...
export const USER_ANONYMIZATION_CONFIRMATION = "ANONYMIZE USER";
...
export const interfaceMessages = {
  en: {
    ...
    "administratorTasks.userSuspensionTeacherAssignment": "Resolve a suspended Teacher's future Class Session assignment.",
    "administratorTasks.userAnonymizationReconciliation": "Reconcile an exhausted User Anonymization.",
    ...
    "administratorTasks.classSession": "Class Session",
    "administratorTasks.formerUser": "Former User identifier",
    "administratorTasks.failure": "Safe failure code",
    ...
    "user-anonymization.completed.administrator": "User Anonymization completed for Former User {userId}.",
    "roleAssignments.help": "Manage Role Assignments and User access, including irreversible anonymization after every future commitment is resolved. Project Owner authority is never available here.",
    "roleAssignments.loading": "Loading Role Assignments…",
    "roleAssignments.loadError": "We couldn't load Role Assignments. Try again.",
    "roleAssignments.user": "User",
    "roleAssignments.action": "Action",
    "roleAssignments.action.grant": "Grant",
    "roleAssignments.action.remove": "Remove",
    "roleAssignments.action.suspend": "Suspend",
    "roleAssignments.action.reactivate": "Reactivate",
    "roleAssignments.action.anonymize": "Anonymize",
    "roleAssignments.role": "Role",
    "roleAssignments.organization": "Organization",
    "roleAssignments.chooseOrganization": "Choose an Organization",
    "roleAssignments.reason": "Reason",
    "roleAssignments.grant": "Grant Role Assignment",
    "roleAssignments.remove": "Remove Role Assignment",
    "roleAssignments.suspend": "Suspend User",
    "roleAssignments.reactivate": "Reactivate User",
    "roleAssignments.anonymize": "Anonymize User",
    "roleAssignments.anonymizeWarning": "This permanently destroys identifying data and cannot be undone. Resolve every future commitment first.",
    "roleAssignments.confirmAnonymize": "Type ANONYMIZE USER to confirm",
    "roleAssignments.granted": "Role Assignment granted.",
    "roleAssignments.removed": "Role Assignment removed.",
    "roleAssignments.suspended": "User suspended.",
    "roleAssignments.reactivated": "User reactivated.",
    "roleAssignments.anonymizationPending": "User Anonymization accepted. Identity deletion is pending.",
    "roleAssignments.changeError": "We couldn't change the Role Assignment. Try again.",
    "roleAssignments.error.INVALID_REASON": "Enter a concise reason from 3 through 200 characters without surrounding spaces.",
    "roleAssignments.error.INVALID_ANONYMIZATION_REASON": "Enter an anonymization reason from 10 through 500 characters without surrounding spaces.",
    "roleAssignments.error.USER_NOT_FOUND": "Choose an existing User.",
    "roleAssignments.error.USER_ANONYMIZED": "An anonymized Former User cannot receive access or be reactivated.",
    "roleAssignments.error.ROLE_ALREADY_ASSIGNED": "The User already has this Role Assignment.",
    "roleAssignments.error.ROLE_NOT_ASSIGNED": "The User does not have this Role Assignment.",
    "roleAssignments.error.ORGANIZATION_REQUIRED": "Choose an Organization for the Organization Manager Role Assignment.",
    "roleAssignments.error.ORGANIZATION_NOT_FOUND": "Choose an existing Organization.",
    "roleAssignments.error.FINAL_PLATFORM_ADMINISTRATOR": "The final active Platform Administrator Role Assignment cannot be removed.",
    "roleAssignments.error.SELF_PLATFORM_ADMINISTRATOR_REMOVAL": "A Platform Administrator cannot remove their own administrative access.",
    "roleAssignments.error.TEACHER_ASSIGNMENTS_REQUIRE_RESOLUTION": "Substitute the Teacher or cancel every future Class Session before removing this Role Assignment.",
    "roleAssignments.error.IDEMPOTENCY_KEY_REUSED": "That request identifier was already used for a different Role Assignment change.",
    "roleAssignments.error.USER_ALREADY_SUSPENDED": "The User is already suspended.",
    "roleAssignments.error.USER_NOT_SUSPENDED": "The User is not suspended.",
    "roleAssignments.error.SELF_SUSPENSION": "A Platform Administrator cannot suspend their own User.",
    "roleAssignments.error.FINAL_ACTIVE_PLATFORM_ADMINISTRATOR": "The final active Platform Administrator cannot be suspended.",
    "roleAssignments.error.CONFIRMATION_REQUIRED": "Type ANONYMIZE USER exactly to accept this irreversible operation.",
    "roleAssignments.error.USER_ALREADY_ANONYMIZED": "The User is already anonymized.",
    "roleAssignments.error.USER_ANONYMIZATION_PENDING": "The User's anonymization is already pending identity deletion.",
    "roleAssignments.error.SELF_ANONYMIZATION": "A Platform Administrator cannot anonymize their own User.",
    "roleAssignments.error.PRIVILEGED_ACCESS_REQUIRES_RESOLUTION": "Remove privileged Role Assignments before anonymizing the User.",
    "roleAssignments.error.FUTURE_COMMITMENTS_REQUIRE_RESOLUTION": "Resolve every future commitment and open request before anonymizing the User.",
    "roleAssignments.error.PUBLIC_DEMONSTRATION_PROTECTED": "User access changes are unavailable in the public demonstration.",
    "roleAssignments.futureAssignments": "Resolve these future Class Sessions first:",
    "roleAssignments.activeRoles": "Active Role Assignments",
    "roleAssignments.noRoles": "No active Role Assignments.",
    "roleAssignments.access.active": "Access active",
    "roleAssignments.access.suspended": "Suspended: {reason}",
    "roleAssignments.access.anonymized": "Anonymized",
    "roleAssignments.access.anonymizationPending": "Anonymization pending identity deletion",
    "roleAssignments.history": "Role Assignment history",
    "roleAssignments.noHistory": "No Role Assignment changes have been recorded.",
    "roleAssignments.history.granted": "Granted {role} on {changedAt}: {reason}",
    "roleAssignments.history.removed": "Removed {role} on {changedAt}: {reason}",
    ...
    "role-assignment.granted.user": "The {role, select, STUDENT {Student} TEACHER {Teacher} ORGANIZATION_MANAGER {Organization Manager} PLATFORM_ADMINISTRATOR {Platform Administrator} other {selected}} Role Assignment was granted effective {effectiveAt, date, long} at {effectiveAt, time, short}. Open {workspacePath}, then confirm the workspace change when prompted. Your other Role Assignments and history are unchanged.",
    "role-assignment.removed.user": "The {role, select, STUDENT {Student} TEACHER {Teacher} ORGANIZATION_MANAGER {Organization Manager} PLATFORM_ADMINISTRATOR {Platform Administrator} other {selected}} Role Assignment was removed effective {effectiveAt, date, long} at {effectiveAt, time, short}: {reason}. {endedBookingCount, plural, =0 {No future Bookings ended} one {One future Booking ended} other {# future Bookings ended}} and {refundedClassCreditCount, plural, =0 {no Class Credits were returned} one {one Class Credit was returned} other {# Class Credits were returned}}. {subscriptionEnded, select, true {The Subscription ended; owned Class Credits remain.} other {Any owned Class Credits remain.}} Your other Role Assignments, User, and history remain.",
    "user.suspended.user": "Your User was suspended effective {effectiveAt, date, long} at {effectiveAt, time, short}: {reason}. Access across every Role Assignment is blocked, including Organization reporting access. {endedBookingCount, plural, =0 {No future Bookings were removed} one {One future Booking was removed} other {# future Bookings were removed}} and {refundedClassCreditCount, plural, =0 {no Class Credits were returned} one {one Class Credit was returned} other {# Class Credits were returned}}. Grants pause while suspended. Reactivation will not recreate removed commitments or backfill skipped grants.",
    "user.suspended.administrator": "A suspended Teacher has {classSessionCount, plural, one {one future Class Session assignment} other {# future Class Session assignments}} requiring urgent substitution or cancellation work: {classSessionReferences}. The Class Sessions remain published.",
    "user.reactivated.user": "Your User was reactivated effective {effectiveAt, date, long} at {effectiveAt, time, short}. Restored Role Assignments: {restoredRoles}. Your owned Class Credits are available again. Removed commitments, expired invitations, and grants skipped during suspension were not recreated or backfilled; future grants resume on their normal schedule.",
    ...
    "maintenance.heading": "Maintenance in progress",
    "maintenance.explanation": "The shared demonstration is being refreshed. Try again in about a minute.",
  ...
  es: {
    ...
    "administratorTasks.userSuspensionTeacherAssignment": "Resolver la asignación futura de sesión de clase de un docente suspendido.",
    "administratorTasks.userAnonymizationReconciliation": "Conciliar una anonimización de usuario que agotó los reintentos.",
    ...
    "administratorTasks.classSession": "Sesión de clase",
    "administratorTasks.formerUser": "Identificador del antiguo usuario",
    "administratorTasks.failure": "Código de error seguro",
    ...
    "roleAssignments.title": "Asignaciones de roles",
    "user-anonymization.completed.administrator": "Se completó la anonimización del antiguo usuario {userId}.",
    "roleAssignments.help": "Gestione las asignaciones de roles y el acceso de usuario, incluida la anonimización irreversible después de resolver todos los compromisos futuros. La autoridad de Propietario del proyecto nunca está disponible aquí.",
    "roleAssignments.loading": "Cargando asignaciones de roles…",
    "roleAssignments.loadError": "No pudimos cargar las asignaciones de roles. Inténtelo de nuevo.",
    "roleAssignments.user": "Usuario",
    "roleAssignments.action": "Acción",
    "roleAssignments.action.grant": "Otorgar",
    "roleAssignments.action.remove": "Eliminar",
    "roleAssignments.action.suspend": "Suspender",
    "roleAssignments.action.reactivate": "Reactivar",
    "roleAssignments.action.anonymize": "Anonimizar",
    "roleAssignments.role": "Rol",
    "roleAssignments.organization": "Organización",
    "roleAssignments.chooseOrganization": "Elija una organización",
    "roleAssignments.reason": "Motivo",
    "roleAssignments.grant": "Otorgar asignación de rol",
    "roleAssignments.remove": "Eliminar asignación de rol",
    "roleAssignments.suspend": "Suspender usuario",
    "roleAssignments.reactivate": "Reactivar usuario",
    "roleAssignments.anonymize": "Anonimizar usuario",
    "roleAssignments.anonymizeWarning": "Esto destruye permanentemente los datos identificativos y no se puede deshacer. Resuelva primero todos los compromisos futuros.",
    "roleAssignments.confirmAnonymize": "Escriba ANONYMIZE USER para confirmar",
    "roleAssignments.granted": "Asignación de rol otorgada.",
    "roleAssignments.removed": "Asignación de rol eliminada.",
    "roleAssignments.suspended": "Usuario suspendido.",
    "roleAssignments.reactivated": "Usuario reactivado.",
    "roleAssignments.anonymizationPending": "Se aceptó la anonimización del usuario. La eliminación de identidad está pendiente.",
    "roleAssignments.changeError": "No pudimos cambiar la asignación de rol. Inténtelo de nuevo.",
    "roleAssignments.error.INVALID_REASON": "Ingrese un motivo conciso de 3 a 200 caracteres, sin espacios al principio ni al final.",
    "roleAssignments.error.INVALID_ANONYMIZATION_REASON": "Ingrese un motivo de anonimización de 10 a 500 caracteres, sin espacios al principio ni al final.",
    "roleAssignments.error.USER_NOT_FOUND": "Elija un usuario existente.",
    "roleAssignments.error.USER_ANONYMIZED": "Un antiguo usuario anonimizado no puede recibir acceso ni reactivarse.",
    "roleAssignments.error.ROLE_ALREADY_ASSIGNED": "El usuario ya tiene esta asignación de rol.",
    "roleAssignments.error.ROLE_NOT_ASSIGNED": "El usuario no tiene esta asignación de rol.",
    "roleAssignments.error.ORGANIZATION_REQUIRED": "Elija una organización para la asignación del rol de responsable de organización.",
    "roleAssignments.error.ORGANIZATION_NOT_FOUND": "Elija una organización existente.",
    "roleAssignments.error.FINAL_PLATFORM_ADMINISTRATOR": "No se puede eliminar la última asignación activa de administración de la plataforma.",
    "roleAssignments.error.SELF_PLATFORM_ADMINISTRATOR_REMOVAL": "Una persona administradora no puede eliminar su propio acceso administrativo.",
    "roleAssignments.error.TEACHER_ASSIGNMENTS_REQUIRE_RESOLUTION": "Sustituya al docente o cancele todas las sesiones de clase futuras antes de eliminar esta asignación de rol.",
    "roleAssignments.error.IDEMPOTENCY_KEY_REUSED": "Ese identificador de solicitud ya se usó para otro cambio de asignación de rol.",
    "roleAssignments.error.USER_ALREADY_SUSPENDED": "El usuario ya está suspendido.",
    "roleAssignments.error.USER_NOT_SUSPENDED": "El usuario no está suspendido.",
    "roleAssignments.error.SELF_SUSPENSION": "Una persona administradora no puede suspender su propio usuario.",
    "roleAssignments.error.FINAL_ACTIVE_PLATFORM_ADMINISTRATOR": "No se puede suspender a la última persona administradora activa de la plataforma.",
    "roleAssignments.error.CONFIRMATION_REQUIRED": "Escriba ANONYMIZE USER exactamente para aceptar esta operación irreversible.",
    "roleAssignments.error.USER_ALREADY_ANONYMIZED": "El usuario ya está anonimizado.",
    "roleAssignments.error.USER_ANONYMIZATION_PENDING": "La anonimización del usuario ya está pendiente de eliminación de identidad.",
    "roleAssignments.error.SELF_ANONYMIZATION": "Una persona administradora no puede anonimizar su propio usuario.",
    "roleAssignments.error.PRIVILEGED_ACCESS_REQUIRES_RESOLUTION": "Elimine las asignaciones de roles privilegiados antes de anonimizar al usuario.",
    "roleAssignments.error.FUTURE_COMMITMENTS_REQUIRE_RESOLUTION": "Resuelva todos los compromisos futuros y solicitudes abiertas antes de anonimizar al usuario.",
    "roleAssignments.error.PUBLIC_DEMONSTRATION_PROTECTED": "Los cambios de acceso de usuario no están disponibles en la demostración pública.",
    "roleAssignments.futureAssignments": "Resuelva primero estas sesiones de clase futuras:",
    "roleAssignments.activeRoles": "Asignaciones de roles activas",
    "roleAssignments.noRoles": "No hay asignaciones de roles activas.",
    "roleAssignments.access.active": "Acceso activo",
    "roleAssignments.access.suspended": "Suspendido: {reason}",
    "roleAssignments.access.anonymized": "Anonimizado",
    "roleAssignments.access.anonymizationPending": "Anonimización pendiente de eliminación de identidad",
    "roleAssignments.history": "Historial de asignaciones de roles",
    "roleAssignments.noHistory": "No se registraron cambios de asignaciones de roles.",
    "roleAssignments.history.granted": "Se otorgó {role} el {changedAt}: {reason}",
    "roleAssignments.history.removed": "Se eliminó {role} el {changedAt}: {reason}",
    ...
    "role-assignment.granted.user": "Se otorgó la asignación del rol {role, select, STUDENT {Estudiante} TEACHER {Docente} ORGANIZATION_MANAGER {Gerente de organización} PLATFORM_ADMINISTRATOR {Administrador de la plataforma} other {seleccionado}} con vigencia desde el {effectiveAt, date, long} a las {effectiveAt, time, short}. Abra {workspacePath} y confirme el cambio de espacio cuando se le solicite. Sus otras asignaciones de roles y su historial no cambiaron.",
    "role-assignment.removed.user": "Se eliminó la asignación del rol {role, select, STUDENT {Estudiante} TEACHER {Docente} ORGANIZATION_MANAGER {Gerente de organización} PLATFORM_ADMINISTRATOR {Administrador de la plataforma} other {seleccionado}} con vigencia desde el {effectiveAt, date, long} a las {effectiveAt, time, short}: {reason}. {endedBookingCount, plural, =0 {No terminó ninguna reserva futura} one {Terminó una reserva futura} other {Terminaron # reservas futuras}} y {refundedClassCreditCount, plural, =0 {no se devolvieron créditos de clase} one {se devolvió un crédito de clase} other {se devolvieron # créditos de clase}}. {subscriptionEnded, select, true {Terminó la suscripción; se conservaron los créditos de clase propios.} other {Se conservan los créditos de clase propios.}} Se conservan sus otras asignaciones de roles, su usuario y su historial.",
    "user.suspended.user": "Su usuario fue suspendido con vigencia desde el {effectiveAt, date, long} a las {effectiveAt, time, short}: {reason}. El acceso queda bloqueado en todas las asignaciones de roles, incluido el acceso a informes de la organización. {endedBookingCount, plural, =0 {No se eliminó ninguna reserva futura} one {Se eliminó una reserva futura} other {Se eliminaron # reservas futuras}} y {refundedClassCreditCount, plural, =0 {no se devolvieron créditos de clase} one {se devolvió un crédito de clase} other {se devolvieron # créditos de clase}}. Las concesiones se pausan durante la suspensión. La reactivación no recreará compromisos eliminados ni repondrá concesiones omitidas.",
    "user.suspended.administrator": "Un docente suspendido tiene {classSessionCount, plural, one {una asignación futura de sesión de clase} other {# asignaciones futuras de sesiones de clase}} que requiere sustitución o cancelación urgente: {classSessionReferences}. Las sesiones de clase siguen publicadas.",
    "user.reactivated.user": "Su usuario fue reactivado con vigencia desde el {effectiveAt, date, long} a las {effectiveAt, time, short}. Asignaciones de roles restauradas: {restoredRoles}. Sus créditos de clase propios vuelven a estar disponibles. No se recrearon compromisos eliminados ni invitaciones vencidas, ni se repusieron concesiones omitidas durante la suspensión; las concesiones futuras continúan según su calendario normal.",
    ...
    "maintenance.heading": "Mantenimiento en curso",
    "maintenance.explanation": "La demostración compartida se está actualizando. Vuelve a intentarlo en aproximadamente un minuto.",
