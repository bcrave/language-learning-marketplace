...
export type BookingFieldsFragment = { id: string, state: BookingState, terminalReason: BookingTerminalReason | null, classCreditRefunded: boolean, bookedAt: string, endedAt: string | null, classSession: { id: string, startsAt: string, endsAt: string, occupiedSeats: number, seatCapacity: number } } & { ' $fragmentName'?: 'BookingFieldsFragment' };
