...
export type MarketplaceOperationalReportQuery = { marketplaceOperationalReport: { generatedAt: string, range: { fromLocalDate: string, toLocalDate: string, timeZone: string }, attendance: { attendedCount: number, noShowCount: number, recordedCount: number, attendanceRatePercentage: number | null, excludedUnrecordedCount: number, correctedCount: number, exceptionCount: number }, cancellations: { studentCancellationCount: number, timelyCount: number, lateCount: number, studentCancellationRatePercentage: number | null, excludedClassSessionCancellationCount: number, excludedRescheduleCount: number, dailyRates: Array<{ localDate: string, studentCancellationCount: number, timelyCount: number, lateCount: number, recordedOutcomeCount: number, studentCancellationRatePercentage: number | null }> }, corrections: { correctedAttendanceCount: number, lastCorrectedAt: string | null, pendingAttendanceReviewCount: number }, credits: { creditAdjustmentCount: number, grantedCount: number, refundedCount: number, deductedCount: number, netCreditChange: number, bySource: Array<{ source: ClassCreditLedgerSource, entryCount: number, netAmount: number }> }, courseProgress: Array<{ courseId: string, courseTitle: string, targetLanguage: string, curriculumLevel: CurriculumLevel, activeLessonUnitCount: number, completedActiveLessonUnitCount: number, studentsWithProgressCount: number, averageProgressPercentage: number }>, exceptions: { totalCount: number, items: Array<{ kind: MarketplaceExceptionKind, classSessionId: string, occurredAt: string, courseTitle: string, lessonUnitTitle: string, teacherDisplayName: string, affectedBookingCount: number }> } } };
