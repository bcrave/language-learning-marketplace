...
export interface UsersTable {
  ...
  anonymized_at: Generated<Date | null>;
  anonymized_by_user_id: Generated<string | null>;
  created_at: Generated<Date>;
}

export interface UserAnonymizationRequestsTable {
  user_id: string;
  identity_issuer: string | null;
  identity_subject: string | null;
  reason: string;
  ...
  redacted_learning_feedback_count: number;
  redacted_session_rating_count: number;
...
export interface UserAccessChangesTable {
  id: Generated<string>;
  user_id: string;
...
export interface RoleAssignmentChangesTable {
  id: Generated<string>;
  user_id: string;
  role: UserRole;
...
export interface AuditEntriesTable {
  ...
  system_identity: "CLASS_SESSION_REMINDER_WORKER" | "WAITLIST_WORKER" | "NOTIFICATION_DELIVERY_WORKER" | "NOTIFICATION_MAINTENANCE_WORKER" | "SPONSORSHIP_INVITATION_WORKER" | "SPONSORSHIP_CREDIT_WORKER" | "REPORT_EXPORT_WORKER" | "USER_ANONYMIZATION_WORKER" | "AUDIT_RETENTION_WORKER" | null;
...
export interface AdministratorTaskItemsTable { id: Generated<string>; required_role: Generated<"PLATFORM_ADMINISTRATOR">; kind: "NOTIFICATION_DELIVERY_RECONCILIATION" | "USER_SUSPENSION_TEACHER_ASSIGNMENT" | "USER_ANONYMIZATION_RECONCILIATION"; state: Generated<"OPEN" | "RESOLVED">; correlation_reference: string; safe_context: JSONColumnType<{ channel: "EMAIL"; messageId: string; recipientReference: string } | { classSessionId: string; suspendedUserId: string } | { anonymizedUserId: string; failureCode: string }>; source_reference: string; recipient_reference: string; created_at: Generated<Date>; resolved_at: Generated<Date | null>; resolution_reason: Generated<string | null> }
...
export interface DatabaseSchema {
  users: UsersTable;
  user_anonymization_requests: UserAnonymizationRequestsTable;
  user_access_changes: UserAccessChangesTable;
