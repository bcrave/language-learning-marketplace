...
export interface UsersTable {
  ...
  access_status: Generated<"ACTIVE" | "SUSPENDED">;
...
export interface AdministratorTaskItemsTable { id: Generated<string>; required_role: Generated<"PLATFORM_ADMINISTRATOR">; kind: "NOTIFICATION_DELIVERY_RECONCILIATION" | "USER_SUSPENSION_TEACHER_ASSIGNMENT"; state: Generated<"OPEN" | "RESOLVED">; correlation_reference: string; safe_context: JSONColumnType<{ channel: "EMAIL"; messageId: string; recipientReference: string } | { classSessionId: string; suspendedUserId: string }>; source_reference: string; recipient_reference: string; created_at: Generated<Date>; resolved_at: Generated<Date | null>; resolution_reason: Generated<string | null> }
